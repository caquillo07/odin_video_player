...
DCT :: struct {
    ...
    get_pixels:           proc(block: ^i16,  /* align 16 */pixels: ^u8,  /* align 8 */line_size: uintptr), //ptrdiff_t. Is this a uintptr?
    bits_per_sample:      i32,
    get_pixels_unaligned: proc(block: ^i16,  /* align 16 */pixels: ^u8,  /* align 8 */line_size: uintptr), //ptrdiff_t. Is this a uintptr?
}
